...
// New V3 history node with metadata based on block state (ZIP 221 as amended by ZIP 229;
// adds the Ironwood fields from NU6.3).
...
// Returns true if this epoch used the V2 history tree format (NU5 through NU6.2).
