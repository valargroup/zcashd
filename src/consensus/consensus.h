...
/** The minimum allowed ZIP248 transaction version (network rule) */
static const int32_t ZIP248_MIN_TX_VERSION = 6;
/** The maximum allowed ZIP248 transaction version (network rule) */
static const int32_t ZIP248_MAX_TX_VERSION = 6;
